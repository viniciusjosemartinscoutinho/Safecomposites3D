# -*- coding: utf-8 -*-
#  & "C:/Program Files/Python311/python.exe" C:\Users\ucfil\Desktop\desktop\codes\all\composites\Safecomposites\Interfaces\Interface_of_Calcul_FRA.py  #serie
# Start-Process "C:/Program Files/Python311/python.exe"  -ArgumentList "C:\Users\ucfil\Desktop\desktop\codes\all\composites\Safecomposites\Interfaces\Interface_of_Calcul_FRA.py"  #parallelism


#________________________________________________ BIBLIOTHEQUES ______________________________________________
from tkinter import *
...
#________________________________________________ Définition des FONCTIONS ______________________________________________
def reset_entry_BLOC1():
    EL_tf.delete(0,'end')
    ET_tf.delete(0,'end')
    GLT_tf.delete(0,'end')
    VLT_tf.delete(0,'end')
...
def Dessin1():
    ...
    about_window.title("Représentation graphique")
    n = Liste_nb_couche.get()
    lb = Label(about_window, text=f"Représentation graphique des déformations dans le stratifié à {n} couches")
    lb.pack()
...
def Dessin2():
    ...
    about_window.title("Représentation graphique")
    n = Liste_nb_couche.get()
    lb = Label(about_window, text=f"Représentation graphique des déformations dans chacune des couches ({n} couches)")
    lb.pack()
    ...
    # On réalise le graphique
    draw_samples(canvas)
    Tracer_eps_couche(canvas)
   
 
def Validation1():
    """"Permet la création de n couches avec leurs zones de saisie associées"""    
    Nb_couche = int(Liste_nb_couche.get())
    
    # Label pour les angles et les épaisseurs
    Angle_lb = Label(
        frame1,
        text="Angles (en °)")
    ...
    Epaisseur_lb = Label(
        frame1,
        text="Epaisseurs (en mm)")
    Epaisseur_lb.grid(row=10, column=3, sticky='w') 

    global Angle1_ent
    global Epaisseur1_ent
    global Angle2_ent
    global Epaisseur2_ent
    global Angle3_ent
    global Epaisseur3_ent
    global Angle4_ent
    global Epaisseur4_ent
    global Angle5_ent
    global Epaisseur5_ent
    global Angle6_ent
    global Epaisseur6_ent
    global Angle7_ent
    global Epaisseur7_ent
    global Angle8_ent
    global Epaisseur8_ent
    
## Pour 1 couche :
    if Nb_couche==1:
        Couche1 = Label(frame1, text="Couche 1")
        Couche1.grid(row=11, column=1, sticky='e')
        Angle1_ent = Entry(frame1)
        Angle1_ent.grid(row=11, column=2, sticky='w') 
        Epaisseur1_ent = Entry(frame1)
        Epaisseur1_ent.grid(row=11, column=3, sticky='w')    
...
## Pour 2 couches :
    if Nb_couche==2:
        ...
        Epaisseur1_ent = Entry(frame1)
        Epaisseur1_ent.grid(row=11, column=3, sticky='w')    
        Couche2 = Label(frame1, text="Couche 1")
        Couche2.grid(row=12, column=1, sticky='e') 
        Angle2_ent = Entry(frame1)
        Angle2_ent.grid(row=12, column=2, sticky='w')         
        Epaisseur2_ent = Entry(frame1)
        Epaisseur2_ent.grid(row=12, column=3, sticky='w') 
...
## Pour 3 couches :
    if Nb_couche==3:
        ...
        Epaisseur1_ent = Entry(frame1)
        Epaisseur1_ent.grid(row=11, column=3, sticky='w') 
        Couche2 = Label(frame1, text="Couche 2")
        Couche2.grid(row=12, column=1, sticky='e') 
        Angle2_ent = Entry(frame1)
        Angle2_ent.grid(row=12, column=2, sticky='w') 
        Epaisseur2_ent = Entry(frame1)
        Epaisseur2_ent.grid(row=12, column=3, sticky='w') 
        Couche3 = Label(frame1, text="Couche 3")
        Couche3.grid(row=13, column=1, sticky='e') 
        Angle3_ent = Entry(frame1)
        Angle3_ent.grid(row=13, column=2, sticky='w') 
        Epaisseur3_ent = Entry(frame1)
        Epaisseur3_ent.grid(row=13, column=3, sticky='w') 
...
## Pour 4 couches :
        ...
        Angle3_ent.grid(row=13, column=2, sticky='w') 
        Epaisseur3_ent = Entry(frame1)
        Epaisseur3_ent.insert(0, "1.5")
        Epaisseur3_ent.grid(row=13, column=3, sticky='w')
        Couche4 = Label(frame1, text="Couche 4")
        Couche4.grid(row=14, column=1, sticky='e') 
        Angle4_ent = Entry(frame1)
        Angle4_ent.insert(0, "30")
        Angle4_ent.grid(row=14, column=2, sticky='w') 
        Epaisseur4_ent = Entry(frame1)
        Epaisseur4_ent.insert(0, "1")
        Epaisseur4_ent.grid(row=14, column=3, sticky='w') 
...
## Pour 5 couches :
        ...
        Epaisseur4_ent = Entry(frame1)
        Epaisseur4_ent.grid(row=14, column=3, sticky='w') 
        Couche5 = Label(frame1, text="Couche 5")
        Couche5.grid(row=15, column=1, sticky='e') 
        Angle5_ent = Entry(frame1)
        Angle5_ent.grid(row=15, column=2, sticky='w') 
        Epaisseur5_ent = Entry(frame1)
        Epaisseur5_ent.grid(row=15, column=3, sticky='w')
...
## Pour 6 couches :
        ...
        Epaisseur5_ent = Entry(frame1)
        Epaisseur5_ent.grid(row=15, column=3, sticky='w')
        Couche6 = Label(frame1, text="Couche 6")
        Couche6.grid(row=16, column=1, sticky='e') 
        Angle6_ent = Entry(frame1)
        Angle6_ent.grid(row=16, column=2, sticky='w') 
        Epaisseur6_ent = Entry(frame1)
        Epaisseur6_ent.grid(row=16, column=3, sticky='w') 
...
## Pour 7 couches :
        ...
        Epaisseur6_ent = Entry(frame1)
        Epaisseur6_ent.grid(row=16, column=3, sticky='w')
        Couche7 = Label(frame1, text="Couche 7")
        Couche7.grid(row=17, column=1, sticky='e') 
        Angle7_ent = Entry(frame1)
        Angle7_ent.grid(row=17, column=2, sticky='w') 
        Epaisseur7_ent = Entry(frame1)
        Epaisseur7_ent.grid(row=17, column=3, sticky='w')
...
## Pour 8 couches :
        ...
        Epaisseur7_ent = Entry(frame1)
        Epaisseur7_ent.grid(row=17, column=3, sticky='w')
        Couche8 = Label(frame1, text="Couche 8")
        Couche8.grid(row=18, column=1, sticky='e') 
        Angle8_ent = Entry(frame1)
        Angle8_ent.grid(row=18, column=2, sticky='w') 
        Epaisseur8_ent = Entry(frame1)
        Epaisseur8_ent.grid(row=18, column=3, sticky='w') 
...
def Calcul_hauteur():
    ...
    if Nb_couche==2:
        e1 = float(Epaisseur1_ent.get())
        e2 = float(Epaisseur2_ent.get())
        E = [e1,e2]
        z0 = -(sum(E)/2)
        Z = [z0]
        i=1
...
def Afficher_hauteur():
    Nb_couche = int(Liste_nb_couche.get())  
    Z = Calcul_hauteur()   
    for i in range(Nb_couche+1):
        a = "Hauteur Z"+f'{i}'+" = "+str(Z[i])
...
# Calcul des constantes de rigidité dans les axes principaux    
def Calcul_Q():
    EL = EL_tf.get()
    EL = float(EL)
    ET = ET_tf.get()
    ...
    Q12 = VLT*Q22
    Q66 = GLT
    # messagebox.showinfo('Constantes de rigidités axes principaux', f' Q11 = {Q11} GPa \n Q22 = {Q22} GPa \n Q12 = {Q12} GPa \n Q66 = {Q66} GPa')
    return(Q11,Q22,Q12,Q66)

    

def Calcul_Q_prime(Angle):
    """Fait appel à la fonction Calcul_Q()"""
    ...
    # messagebox.showinfo('Constantes de rigidités axes des couches', f' Qxx_prime = {Qxx} GPa \n Qyy_prime = {Qyy} GPa \n Qxy_prime = {Qxy} GPa \n Qxz_prime = {Qxz} GPa \n Qyz_prime = {Qyz} GPa \n Qzz_prime = {Qzz} GPa')
    return(Q_prime)
...
def Vecteur_CI():
    Nx = 1000*int(Nx_tf.get())
    Ny = 1000*int(Ny_tf.get())
    Nz = 1000*int(Nz_tf.get())
...
# Calcul des déformations dans les axes principaux du STRATIFIE
...
def Calcul_eps_couche(z, Angle):
    """Retourne Eps_L, Eps_T et Gamma_LT"""
    n = int(Liste_nb_couche.get())     
    # Invariants
    ...
    Eps_couche = np.array(([Eps_k[0]+z*Kappa_k[0]],
                           [Eps_k[1]+z*Kappa_k[1]],
                           [Eps_k[2]+z*Kappa_k[2]]))
    return(Eps_couche)
...
def Calcul_eps_couche_totales():
    """Renvoie matrice 3 lignes et 2*n colonnes"""
    n = int(Liste_nb_couche.get())
    Z = Calcul_hauteur()
    ...
    if n==1: 
        z = float(Z[0])
        Angle = int(Angle1_ent.get())
        Eps_couche0 = Calcul_eps_couche(z, Angle)
        z = float(Z[1])
        Angle = int(Angle1_ent.get())
        Eps_couche1 = Calcul_eps_couche(z, Angle)
        M = np.array(([Eps_couche0, Eps_couche1]))            
        return(M)
    ...
    if n==2:
        ...
        z = float(Z[1])        
        Eps_couche1_bis = Calcul_eps_couche(z, Angle)        
        z = float(Z[2])        
        Eps_couche2 = Calcul_eps_couche(z, Angle)             
        M = np.array(([Eps_couche0, Eps_couche1, Eps_couche1_bis, Eps_couche2]))            
        return(M)
    ...
    if n==3:
        ...
        z = float(Z[2])        
        Eps_couche2_bis = Calcul_eps_couche(z, Angle)        
        z = float(Z[3])        
        Eps_couche3 = Calcul_eps_couche(z, Angle)      
        M = np.array(([Eps_couche0, Eps_couche1, Eps_couche1_bis, Eps_couche2, Eps_couche2_bis, Eps_couche3]))            
        return(M)
    ...
    if n==4:
        ...
        z = float(Z[3])        
        Eps_couche3_bis = Calcul_eps_couche(z, Angle)        
        z = float(Z[4])        
        Eps_couche4 = Calcul_eps_couche(z, Angle)   
        M = np.array(([Eps_couche0, Eps_couche1, Eps_couche1_bis, Eps_couche2, Eps_couche2_bis, Eps_couche3, Eps_couche3_bis, Eps_couche4]))            
        return(M)
    ...
    if n==5:
        ...
        z = float(Z[4])        
        Eps_couche4_bis = Calcul_eps_couche(z, Angle)        
        z = float(Z[5])        
        Eps_couche5 = Calcul_eps_couche(z, Angle)          
        M = np.array(([Eps_couche0, Eps_couche1, Eps_couche1_bis, Eps_couche2, Eps_couche2_bis, Eps_couche3, Eps_couche3_bis, Eps_couche4, Eps_couche4_bis, Eps_couche5]))            
        return(M)
    ...
    if n==6:
        ...
        z = float(Z[5])        
        Eps_couche5_bis = Calcul_eps_couche(z, Angle)        
        z = float(Z[6])        
        Eps_couche6 = Calcul_eps_couche(z, Angle)          
        
        M = np.array(([Eps_couche0, Eps_couche1, Eps_couche1_bis, Eps_couche2, Eps_couche2_bis, Eps_couche3, Eps_couche3_bis, Eps_couche4, Eps_couche4_bis, Eps_couche5, Eps_couche5_bis, Eps_couche6]))            
        return(M)
    ...
    if n==7:
        ...
        z = float(Z[6])        
        Eps_couche6_bis = Calcul_eps_couche(z, Angle)        
        z = float(Z[7])        
        Eps_couche7 = Calcul_eps_couche(z, Angle) 
        
        M = np.array(([Eps_couche0, Eps_couche1, Eps_couche1_bis, Eps_couche2, Eps_couche2_bis, Eps_couche3, Eps_couche3_bis, Eps_couche4, Eps_couche4_bis, Eps_couche5, Eps_couche5_bis, Eps_couche6, Eps_couche6_bis, Eps_couche7]))            
        return(M)    
    ...
    if n==8:
        ...
        z = float(Z[7])        
        Eps_couche7_bis = Calcul_eps_couche(z, Angle)        
        z = float(Z[8])        
        Eps_couche8 = Calcul_eps_couche(z, Angle)        
        
        M = np.array(([Eps_couche0, Eps_couche1, Eps_couche1_bis, Eps_couche2, Eps_couche2_bis, Eps_couche3, Eps_couche3_bis, Eps_couche4, Eps_couche4_bis, Eps_couche5, Eps_couche5_bis, Eps_couche6, Eps_couche6_bis, Eps_couche7, Eps_couche7_bis, Eps_couche8]))            
        return(M)  


def Calcul_contrainte_axe_strat(z, Angle):
    print("Calcul contrainte")
...
def Show_info():
    ...
    messagebox.showinfo('Constantes de rigidités axes COUCHE 1', f' Qxx_prime = {Qxx} GPa \n Qyy_prime = {Qyy} GPa \n Qxy_prime = {Qxy} GPa \n Qxz_prime = {Qxz} GPa \n Qyz_prime = {Qyz} GPa \n Qzz_prime = {Qzz} GPa')

    Angle = int(Angle2_ent.get())
    Q_prime = Calcul_Q_prime(Angle)
    Qxx, Qyy, Qxy, Qxz, Qyz, Qzz = Q_prime[0], Q_prime[1], Q_prime[2], Q_prime[3], Q_prime[4], Q_prime[5]
    messagebox.showinfo('Constantes de rigidités axes COUCHE 2', f' Qxx_prime = {Qxx} GPa \n Qyy_prime = {Qyy} GPa \n Qxy_prime = {Qxy} GPa \n Qxz_prime = {Qxz} GPa \n Qyz_prime = {Qyz} GPa \n Qzz_prime = {Qzz} GPa')
 
    Angle = int(Angle3_ent.get())
    Q_prime = Calcul_Q_prime(Angle)
    Qxx, Qyy, Qxy, Qxz, Qyz, Qzz = Q_prime[0], Q_prime[1], Q_prime[2], Q_prime[3], Q_prime[4], Q_prime[5]
    messagebox.showinfo('Constantes de rigidités axes COUCHE 3', f' Qxx_prime = {Qxx} GPa \n Qyy_prime = {Qyy} GPa \n Qxy_prime = {Qxy} GPa \n Qxz_prime = {Qxz} GPa \n Qyz_prime = {Qyz} GPa \n Qzz_prime = {Qzz} GPa')
 
    Angle = int(Angle4_ent.get())
    Q_prime = Calcul_Q_prime(Angle)
    Qxx, Qyy, Qxy, Qxz, Qyz, Qzz = Q_prime[0], Q_prime[1], Q_prime[2], Q_prime[3], Q_prime[4], Q_prime[5]
    messagebox.showinfo('Constantes de rigidités axes COUCHE 4', f' Qxx_prime = {Qxx} GPa \n Qyy_prime = {Qyy} GPa \n Qxy_prime = {Qxy} GPa \n Qxz_prime = {Qxz} GPa \n Qyz_prime = {Qyz} GPa \n Qzz_prime = {Qzz} GPa')
    
    messagebox.showinfo('Matrice A', f' A = {A} *10e6 N/m \n')
    messagebox.showinfo('Matrice B', f' B = {B} *10e3 N \n')
    messagebox.showinfo('Matrice D', f' D = {D} N.m \n')
    
    H = Calcul_H()
    messagebox.showinfo('Matrice H', f' H = {H} \n')

    Eps_kap0 = Calcul_epsilon_kappa0()
    messagebox.showinfo('Matrice de déformation et kappa', f' Eps_kap0 = {Eps_kap0} \n')
...
def Afficher_Q():
    ...
    Q = np.array(([round(Q11,2), round(Q12,2), 0],
                  ...
                  [0, 0, round(Q66,2)]))
    messagebox.showinfo('Affichage de Q (GPa)', f' Q = \n{Q}')       
   
    

def Afficher_Q_prime():
    Nb_couche = int(Liste_nb_couche.get())    
    ...
    if Nb_couche==1:
        ...
        Q_prime = np.array(([Qxx, Qxy, Qxz],
                            [Qxy, Qyy, Qyz],
                            [Qxz, Qyz, Qzz]))
        messagebox.showinfo(f"Affichage de Q'_{Angle}° couche 1 (GPa)", f" Q'_{Angle}° = \n{Q_prime1}")
        ...
        Q_prime1 = np.array(([Qxx, Qxy, Qxz],
                            [Qxy, Qyy, Qyz],
                            [Qxz, Qyz, Qzz]))
        messagebox.showinfo("Affichage de Q' couche 1 (GPa)", f" Q1' = \n{Q_prime1}")
        Angle = int(Angle2_ent.get())
        Q_prime1 = Calcul_Q_prime(Angle)
        Qxx, Qyy, Qxy, Qxz, Qyz, Qzz = Q_prime1[0], Q_prime1[1], Q_prime1[2], Q_prime1[3], Q_prime1[4], Q_prime1[5]
        Qxx, Qyy, Qxy, Qxz, Qyz, Qzz = round(Qxx,3), round(Qyy,3), round(Qxy,3), round(Qxz,3), round(Qyz,3), round(Qzz,3)
        Q_prime1 = np.array(([Qxx, Qxy, Qxz],
                            [Qxy, Qyy, Qyz],
                            [Qxz, Qyz, Qzz]))
        messagebox.showinfo(f"Affichage de Q'_{Angle}° couche 2 (GPa)", f" Q'_{Angle}° = \n{Q_prime1}")
        ...
        Q_prime1 = np.array(([Qxx, Qxy, Qxz],
                            [Qxy, Qyy, Qyz],
                            [Qxz, Qyz, Qzz]))
        messagebox.showinfo(f"Affichage de Q'_{Angle}° couche 3 (GPa)", f" Q'_{Angle}° = \n{Q_prime1}")
        ...
        Q_prime1 = np.array(([Qxx, Qxy, Qxz],
                            [Qxy, Qyy, Qyz],
                            [Qxz, Qyz, Qzz]))
        messagebox.showinfo(f"Affichage de Q'_{Angle}° couche 4 (GPa)", f" Q'_{Angle}° = \n{Q_prime1}")
        ...
        Q_prime1 = np.array(([Qxx, Qxy, Qxz],
                            [Qxy, Qyy, Qyz],
                            [Qxz, Qyz, Qzz]))
        messagebox.showinfo(f"Affichage de Q'_{Angle}° couche 5 (GPa)", f" Q'_{Angle}° = \n{Q_prime1}")
        ...
        Q_prime1 = np.array(([Qxx, Qxy, Qxz],
                            [Qxy, Qyy, Qyz],
                            [Qxz, Qyz, Qzz]))
        messagebox.showinfo(f"Affichage de Q'_{Angle}° couche 6 (GPa)", f" Q'_{Angle}° = \n{Q_prime1}")
        ...
        Q_prime1 = np.array(([Qxx, Qxy, Qxz],
                            [Qxy, Qyy, Qyz],
                            [Qxz, Qyz, Qzz]))
        messagebox.showinfo(f"Affichage de Q'_{Angle}° couche 7 (GPa)", f" Q'_{Angle}° = \n{Q_prime1}")
        ...
        Q_prime1 = np.array(([Qxx, Qxy, Qxz],
                            [Qxy, Qyy, Qyz],
                            [Qxz, Qyz, Qzz]))
        messagebox.showinfo(f"Affichage de Q'_{Angle}° couche 8 (GPa)", f" Q'_{Angle}° = \n{Q_prime1}")



def Afficher_H():
    H = Calcul_H()
    messagebox.showinfo('Affichage de H', f' H = \n{H}')  
    
    

def Afficher_eps_kap0():
    Epsilon_kappa0 = Calcul_epsilon_kappa0()
    Epsilon_kappa0 = Epsilon_kappa0
    messagebox.showinfo('Affichage de Epsilon et Kappa 0', f' Vecteur Epsilon_kappa0 (eps en mm) = \n{Epsilon_kappa0}')  
    


def Afficher_eps_axe_stratifie():  
# Création de la nouvelle fenêtre 1 de calcul des déformations globales (axes du stratifié)    
    # ws1 correspond à la fenêtre d'affichage des déformations dans les axes du stratifié (globaux donc)
    global ws1
    ws1 = Toplevel(ws)
    ws1.title("Calculs de déformation dans les axes du stratifié")
    n = Liste_nb_couche.get()
    # Centrer la fenêtre
...
# Affichage des résultats
    ...
    # Zone et indication de saisie
    Z_label = Label(ws1, text="Entrez la hauteur z (en mm) :")
    Z_label.grid(row=4, column=0, columnspan=2, ipadx=5, pady=5)
    
    global Z_ent
    Z_ent = DoubleVar()
    Z_ent = Entry(ws1)
    Z_ent.insert(0,"2.5") # ICI a changer
    ...
    Calcul1_btn = Button(ws1, text="Calculer", command=Calcul1)
    Calcul1_btn.grid(row=5, column=0, columnspan=4, ipadx=35, ipady=4)


def Calcul1():
    print("Application de Calcul 1")
    decalageX = 20
    z = float(Z_ent.get())
    Liste_Z = Calcul_hauteur()
...
# Nouvel affichage des déformations
    if z>=Zinf and z<=Zsup:    
        ...
        messagebox.showerror('Erreur Python', 'Erreur: La valeur de z est erronée (hors matière) ! \n Elle doit respecter '+f'{Zinf}'+" < z < "+f'{Zsup}')

        
    
def Afficher_eps_axe_couche():
# Création de la nouvelle fenêtre 2 de calcul des déformations dans chaque couche selon leurs axes propres    
    # ws2 correspond à la fenêtre d'affichage des déformations dans les axes de chacune des couches
    global ws2
    ws2 = Toplevel(ws)
    ws2.title("Calculs de déformation dans les axes de chaque couche")
    n = int(Liste_nb_couche.get())
    # Centrer la fenêtre
...
# Affichage des résultats
    ...
    # Label d'affichage des réponses
...
# Création des Zones et Instructions de saisie
    # Dans quelle couche se passe le calcul ?
    Liste_couche_lbl = Label(ws2, text="◉ Quelle couche ?")
    Liste_couche_lbl.place(x=110, y=2.5*decalageY)    
    global Liste_couche
    Liste_couche = IntVar()
    Nb_couche = []
    for i in range(n):
        Nb_couche.append(i+1)   
    Liste_couche = ttk.Combobox(ws2, values=Nb_couche)
    Liste_couche.current(n-1)
    Liste_couche.place(x=260, y=2.5*decalageY)
    
    # Gestion de l'angle
    c = int(Liste_couche.get())
    Angle_ws2_lbl = Label(ws2, text="◉ Angle de la couche (en°) ?")
    ...
    Z_lbl = Label(ws2, text="◉ Hauteur z (en mm) ?")
    ...
    Validation_ws2_btn = Button(ws2, text="Valider", height=1, width=15, command=Calcul2)
    Validation_ws2_btn.place(x=201, y=7.2*decalageY)

# Séparateur de block
    Separateur = Label(ws2, text="_____________________________________________________________________________________________________")
    Separateur.place(x=0, y=8.5*decalageY)



#___________________________________ Aide à la décision pour le choix des entrées _______________________________________
    Titre_aide = Label(ws2, text="Rappel des données du stratifié", font=("ar 10 bold", 11))
    Titre_aide.place(x=150, y=9.8*decalageY)
    # Label pour les angles et les épaisseurs
    h=1
    w=17
    decalageY2 = 20
    ...
    Epaisseur_lbl = Label(ws2, text="Epaisseurs", height=h, width=w, borderwidth=2, relief="ridge")
    Epaisseur_lbl.place(x=220, y=11.2*decalageY2)
    Hauteur_lbl = Label(ws2, text="Hauteurs Zi", height=h, width=w, borderwidth=2, relief="ridge")
    Hauteur_lbl.place(x=340, y=11.2*decalageY2)    
    ...
    if n==1:
        ...
        e6 = float(Epaisseur6_ent.get())
        e7 = float(Epaisseur7_ent.get())
        Epaisseurs=[e7,e6,e5,e4,e3,e2,e1]        
        var = Calcul_hauteur()
        Liste_Z = []
        for i in range(n,-1,-1):
            Liste_Z.append(var[i])
        ...
        e7 = float(Epaisseur7_ent.get())
        e8 = float(Epaisseur8_ent.get())
        Epaisseurs=[e8,e7,e6,e5,e4,e3,e2,e1]        
        var = Calcul_hauteur()
        Liste_Z = []
        for i in range(n,-1,-1):
            Liste_Z.append(var[i])
    ...
    for i in range(n):
        j=i+1
        indic = indices[i]
        Couche = Label(ws2, text="Couche "+f'{indic}'+" :", height=h, width=13, borderwidth=2, relief="ridge")
        Couche.place(x=0, y=(11.2+1.2*j)*decalageY2)      
        ...
        Var = Epaisseurs[i]
        Epaisseur = Label(ws2, text=f"{Var}"+" mm", borderwidth=3, width=w-1, relief="sunken")
        Epaisseur.place(x=223, y=(11.2+1.2*j)*decalageY2)

        Var1 = Liste_Z[i]
        Var2 = Liste_Z[j]
        Hauteur = Label(ws2, text=f"{Var1}"+"  ≤  "+"z"+"  ≤  "+f"{Var2}", borderwidth=3, width=w-1, relief="sunken")
        Hauteur.place(x=345, y=(11.2+1.2*j)*decalageY2)        
...
def Afficher_contraintes_axe_couche():
# Création de la nouvelle fenêtre 3 de calcul des contraintes dans chaque couche selon leurs axes propres    
    # ws2 correspond à la fenêtre d'affichage des déformations dans les axes de chacune des couches
    global ws3
    ws3 = Toplevel(ws)
    ws3.title("Calculs de déformation dans les axes de chaque couche")
    n = int(Liste_nb_couche.get())
    # Centrer la fenêtre
...
# Création des Zones et Instructions de saisie
    # Dans quelle couche se passe le calcul ?
    Liste_couche_lbl = Label(ws3, text="◉ Quelle couche ?")
    Liste_couche_lbl.place(x=110, y=2.5*decalageY)    
    global Liste_couche3
    Liste_couche3 = IntVar()
    Nb_couche = []
    for i in range(n):
        Nb_couche.append(i+1)   
    Liste_couche3 = ttk.Combobox(ws3, values=Nb_couche)
    Liste_couche3.current(n-1)
    Liste_couche3.place(x=260, y=2.5*decalageY)
    
    # Gestion de l'angle
    c = int(Liste_couche3.get())
    Angle_ws3_lbl = Label(ws3, text="◉ Angle de la couche (en°) ?")
    ...
    # Gestion de la hauteur z
    Z_lbl = Label(ws3, text="◉ Hauteur z (en mm) ?")
    Z_lbl.place(x=110, y=5.5*decalageY) 
    global Z_ent3
    Z_ent3 = DoubleVar()
    Z_ent3 = Entry(ws3)
    Z_ent3.insert(0,"2.5") # ICI a changer
    Z_ent3.place(x=260, y=5.5*decalageY) 

    # Bouton de validation de la saisie
    Validation_ws3_btn = Button(ws3, text="Valider", height=1, width=15, command=Calcul3)
    Validation_ws3_btn.place(x=201, y=7.2*decalageY)

# Séparateur de block
    Separateur = Label(ws3, text="_____________________________________________________________________________________________________")
    Separateur.place(x=0, y=8.5*decalageY)


#___________________________________ Aide à la décision pour le choix des entrées _______________________________________
    Titre_aide = Label(ws3, text="Rappel des données du stratifié", font=("ar 10 bold", 11))
    Titre_aide.place(x=150, y=9.8*decalageY)
    # Label pour les angles et les épaisseurs
    h=1
    w=17
    ...
    Angle_lb.place(x=100, y=11.2*decalageY2)   
    Epaisseur_lbl = Label(ws3, text="Epaisseurs", height=h, width=w, borderwidth=2, relief="ridge")
    Epaisseur_lbl.place(x=220, y=11.2*decalageY2)
    Hauteur_lbl = Label(ws3, text="Hauteurs Zi", height=h, width=w, borderwidth=2, relief="ridge")
    Hauteur_lbl.place(x=340, y=11.2*decalageY2)    
    ...
    for i in range(n):
        j=i+1
        indic = indices[i]
        Couche = Label(ws3, text="Couche "+f'{indic}'+" :", height=h, width=13, borderwidth=2, relief="ridge")
        Couche.place(x=0, y=(11.2+1.2*j)*decalageY2)      
        ...
        Var = Epaisseurs[i]
        Epaisseur = Label(ws3, text=f"{Var}"+" mm", borderwidth=3, width=w-1, relief="sunken")
        Epaisseur.place(x=223, y=(11.2+1.2*j)*decalageY2)

        Var1 = Liste_Z[i]
        Var2 = Liste_Z[j]
        Hauteur = Label(ws3, text=f"{Var1}"+"  ≤  "+"z"+"  ≤  "+f"{Var2}", borderwidth=3, width=w-1, relief="sunken")
        Hauteur.place(x=345, y=(11.2+1.2*j)*decalageY2)        
...
# Partie calcul
    ...
    Sigma = Calcul_contrainte_axe_strat(z, Angle)
...
def Validation2():
# TITRE BLOC 4
    Titre_BLOC4 = Label(frame3, font=("ar 10 bold",10), borderwidth=2, width=30, relief="sunken", text="AFFICHAGE DES RESULTATS")
    Titre_BLOC4.grid(row=35, column=4, ipady=4, pady=20)
...
# Boutton d'affichage de Q
    Q_btn = Button(frame3, text='Afficher Q', command=Afficher_Q)
    Q_btn.grid(row=40, column=1, ipadx=32, ipady=7, padx=8)

# Boutton d'affichage de Q prime
    Q_prime_btn = Button(frame3, text="Afficher Q'", command=Afficher_Q_prime)
    Q_prime_btn.grid(row=40, column=2, ipadx=30, ipady=7, padx=8, pady=10)

# Boutton d'affichage de H
    H_btn = Button(frame3, text='Afficher H', command=Afficher_H)
    H_btn.grid(row=40, column=3, ipadx=32, ipady=7, padx=8, pady=10)

# Boutton d'affichage de epsilon 0 et Kappa 0
    Eps_kap0_btn = Button(frame3, text='Afficher vecteur epsilon 0', command=Afficher_eps_kap0)
    Eps_kap0_btn.grid(row=40, column=4, ipady=7, padx=8, pady=10)

# Boutton d'affichage de epsilon dans les axes du stratifié
    Eps_global_btn = Button(frame3, text='Afficher déformations \n (axes du stratifié)', command=Afficher_eps_axe_stratifie)
    Eps_global_btn.grid(row=40, column=5, padx=8, pady=10)

# Boutton d'affichage de epsilon dans les axes de chacune des couches
    Eps_couche_btn = Button(frame3, text='Afficher déformations \n (axes des couches)', command=Afficher_eps_axe_couche)
    Eps_couche_btn.grid(row=40, column=6, padx=8, pady=10)

# Boutton d'affichage des CONTRAINTES dans les axes de chacune des couches
    Contrainte_couche_btn = Button(frame3, text='Afficher contraintes \n (axes des couches)', command=Afficher_contraintes_axe_couche)
    Contrainte_couche_btn.grid(row=40, column=7, ipadx=8, padx=8, pady=10)
...
#________________________________________________ Gestion FENÊTRE ______________________________________________


def main_FRA():
    global ws, screen_x, screen_y, window_x, window_y, posX, posY, geo, frame1, frame2, frame2bis, frame3, frame4, mainmenu, Menu1, Menu2, Menu3, EL_tf, ET_tf, GLT_tf, VLT_tf, Nx_tf, Ny_tf, Nz_tf, Mt_tf, Mfy_tf, Mfz_tf, Titre1_lb, Coeff_mat_lb, EL_lb, ET_lb, GLT_lb, VLT_lb, Nb_couche_lb, Nb_couche, Liste_nb_couche, CL_lb, Nx_lb, Ny_lb, Nz_lb, Mt_lb, Mfy_lb, Mfz_lb, Reset_btn, Validation1_btn, Calculer_hauteur_btn, Validation2_btn, draw_samples, Tracer_eps_stratifie, Tracer_eps_couche
    ws = Tk()  # C'est un widget
    ws.title("Outil de calcul de déformations et de contraintes mécaniques pour les matériaux composites")
    ws.config(bg='#686e70')
    ...
    #________________________________________________ Gestion FRAMES ______________________________________________
    frame1 = Frame(ws)
    frame2 = Frame(ws)
    frame2bis = Frame(ws)
    frame3 = Frame(ws)
    ...
    #________________________________________________ Gestion des MENUS ______________________________________________
    mainmenu = Menu(ws)
    ...
    Menu1.add_separator()
    Menu1.add_command(label="Quitter", command=lambda:ws.destroy())

    Menu2 = Menu(mainmenu)
    Menu2.add_command(label="Déformations globales", command=Dessin1)
    Menu2.add_command(label="Déformations par couches", command=Dessin2)

    Menu3 = Menu(mainmenu)
    Menu3.add_command(label="Théorie des stratifiés")
    Menu3.add_command(label="Fonctionnement de l'outil")


    # Création d'un menu déroulant
    mainmenu.add_cascade(label="Menu 1", menu=Menu1)
    mainmenu.add_cascade(label="Représentations graphiques", menu=Menu2)
    ...
    #____________________________________________  WIDGETS du BLOC 1  ___________________________________________________
    # NOM DU BLOC GENERAL
    Titre1_lb = Label(frame1,
                   text="Calculs de contraintes et déformations",
                   font=("ar 10 bold", 20))
    Titre1_lb.grid(row=1, column=0, columnspan=10, padx=325, pady=10)    


    #################### SOUS BLOC DE GAUCHE ####################
    Coeff_mat_lb = Label(frame1,
                         text="Coefficients liés au matériau",
                         font="ar 10 bold")
    Coeff_mat_lb.grid(row=2, column=1, columnspan=2, ipadx=100)

    # LABELS des Coeff Matériaux
    EL_lb = Label(
        frame1,
        text="Module d'Young LONGITUDINAL EL (en GPa) :")
    EL_lb.grid(row=3, column=1)

    ET_lb = Label(
        frame1,
        text="Module d'Young TRANSVERSAL ET (en GPa) :")
    ET_lb.grid(row=4, column=1)

    GLT_lb = Label(
        frame1,
        text="Module de cisaillement GLT (en GPa) :")
    GLT_lb.grid(row=5, column=1)

    VLT_lb = Label(
        frame1,
        text="Coefficient de Poisson VLT :")
    VLT_lb.grid(row=6, column=1)

    Nb_couche_lb = Label(
        frame1,
        text="Nombre de couches :")
    Nb_couche_lb.grid(row=7, column=1, rowspan=2)


    # ENTRIES des Coeff Matériaux
    EL_tf = DoubleVar()
    EL_tf = Entry(frame1)
    EL_tf.insert(0,"38")
    ...
    Nb_couche = [1, 2, 3, 4, 5, 6, 7, 8]
    Liste_nb_couche = ttk.Combobox(frame1, values=Nb_couche)
    Liste_nb_couche.current(3)
    Liste_nb_couche.grid(row=7, column=2, rowspan=2)
    #____________
    ...
    # LABELS des Conditions aux Limites
    Nx_lb = Label(
        frame1,
        text="Nx (en Newton) :")
    ...
    # ENTRIES des Conditions aux Limites
    Nx_tf = DoubleVar()
    Nx_tf = Entry(frame1)
    Nx_tf.insert(0,"1000")
    ...
    #____________________________________________  WIDGETS du BLOC 2  ___________________________________________________

    # Boutton de reset des Paramètres Généraux
    Reset_btn = Button(
        frame1,
        text='Effacer la saisie',
        command=reset_entry_BLOC1,
        width=30)
    Reset_btn.grid(row=9, column=0, columnspan=3, pady=5, sticky='e')


    # Boutton de Validation et création des couches
    Validation1_btn = Button(
        frame1,
        text='Valider',
        command=Validation1,
        width=30)
    Validation1_btn.grid(row=9, column=3, columnspan=2, pady=5, sticky='w')
    #-----------------------------------------------------------------------------------------------------------------
    ...
    #____________________________________________  WIDGETS du BLOC 3  ___________________________________________________
    # Boutton de Validation et création des couches
    Calculer_hauteur_btn = Button(frame2,text='Afficher les hauteurs Zi',command=Afficher_hauteur)
    Calculer_hauteur_btn.grid(padx=495, pady=10)

    # Boutton de Validation et création des couches
    Validation2_btn = Button(frame2,text='Valider',command=Validation2)
    ...
    #____________________________________________  CANVAS de DESSIN  ___________________________________________________
    def draw_samples(canvas):
        """Tracer des plans de chacune des couches ainsi qu'affichage des angles des couches"""
        Z = Calcul_hauteur()
        # Plan médian
        x0,y0 = 0,250
        Nb_couche = int(Liste_nb_couche.get())
    ...
    # Dessin de la zone des angles
        x0, y0 = 100,250-f*Z[0]    
        x1, y1 = 100, 250+f*Z[0]
        canvas.create_line( (x0,y0), (x1,y1) )


    def Tracer_eps_stratifie(canvas):    
        Z = Calcul_hauteur()
        # Plan médian
        x0,y0 = 0,250
        Nb_couche = int(Liste_nb_couche.get())
        ...
        # On peut mettre des valeurs absolues si on sait que la déformation est négative ?????????
    ...
    def Tracer_eps_couche(canvas):
        print("On va dessiner les déformations dans chacune des couches du stratifié")
        Z = Calcul_hauteur()
        # Plan médian
        x0,y0 = 0,250
        Nb_couche = int(Liste_nb_couche.get())
