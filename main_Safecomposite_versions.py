...
#  & "C:/Program Files/Python311/python.exe" C:\Users\ucfil\Desktop\desktop\codes\all\composites\Safecomposites\main_Safecomposite_versions.py
# Start-Process "C:/Program Files/Python311/python.exe"  -ArgumentList "C:\Users\ucfil\Desktop\desktop\codes\all\composites\Safecomposites\main_Safecomposite_versions.py" #parallelism
...
def install_packages() -> None:
    ...
    if getattr(sys, "frozen", False):
        print("[SKIP] Rodando como .exe congelado — não dá pra fazer pip install; "
              "os pacotes precisam estar todos empacotados no build.")
        """Instala apenas os pacotes que ainda não existem."""
        return
